...
namespace BGC.StateMachine
{
    public abstract class State
    {
            ...
            Action<string, bool> setBool)
        {
            ...
            {
                throw new ArgumentNullException(nameof(activateTrigger),
                    message: "activateTrigger function cannot be null.");
            }

            if (getTrigger == null)
            {
                throw new ArgumentNullException(nameof(getTrigger),
                    message: "getTrigger function cannot be null.");
            }

            if (getBool == null)
            {
                throw new ArgumentNullException(nameof(getBool),
                    message: "getBool function cannot be null.");
            }

            if (setBool == null)
            {
                throw new ArgumentNullException(nameof(setBool),
